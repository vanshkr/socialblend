...
export const Home = () => {
  return (
    <div className="h-full flex">
      {/* SideNav for desktop */}
      <aside className="w-fit hidden md:block xl:w-[20%] border-r border-gray-100">
        <SideNav />
      </aside>
      ...
      <nav className="fixed bottom-0 left-0 right-0 border-t-2 border-gray-100 block md:hidden bg-white">
        <BottomNav />
      </nav>
    </div>
  );
